...
case class GetColor() extends GraphicsOp[Color]
case class SetColor(color: Color) extends GraphicsOp[Unit]
case class GetFont() extends GraphicsOp[Font]
case class SetFont(font: Font) extends GraphicsOp[Unit]
